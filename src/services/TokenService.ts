...
// Remove the analyzeAndCopyTokens function
// const analyzeAndCopyTokens = async () => {
//   try {
//     const { data, error } = await supabase.rpc('analyze_and_copy_tokens');
//     if (error) throw error;
//     console.log('Analyze and copy tokens function executed successfully:', data);
//   } catch (err) {
//     console.error('Error executing analyze_and_copy_tokens:', err);
//     throw err;
//   }
// };
